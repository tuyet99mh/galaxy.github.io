...
<div class='container-fluid'>
	<div id="head" class="">
		...
		<div class="row">
			...
			<div class="col-sm-2"><a href="index.php"><img src="asset/image/BLL1.png" alt=""  width= '50px'></a></div>
			<div class="col-sm-6" id ="logo"><a href="home1.php" > WWatch Shop</a></div>
			<div class="col-sm-2 headItem" id="search">
			

				<input type="text" name="txtSearch" id="" placeholder="First name">
				<a href="#"><span class="glyphicon glyphicon-search">abc</span></a>	
